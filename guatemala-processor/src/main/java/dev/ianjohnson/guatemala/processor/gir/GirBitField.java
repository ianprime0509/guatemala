...
public record GirBitField(String name, String getType, List<GirMember> members, List<GirCallable> functions) implements Named {
    public static boolean canLoad(Element element) {
        return NS.CORE.equals(element.getNamespaceURI()) && "bitfield".equals(element.getLocalName());
    }

    public static GirBitField load(Element element, String ns) {
        ...
        return new GirBitField(name, getType, List.copyOf(members), List.copyOf(functions));
    }
